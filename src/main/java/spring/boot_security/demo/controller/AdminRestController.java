...
import spring.boot_security.demo.services.RoleService;
import spring.boot_security.demo.services.UserService;
import java.util.*;
...
public class AdminRestController {
    ...
    @Autowired
    public AdminRestController(UserService userService, RoleService roleService, PatientService patientService) {
